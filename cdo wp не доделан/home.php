					...
					<div class="row">
						<div class="col-xl-3 col-md-6">
							<div class="program-card">
								...
								<a href="training-mei.php" class="program-card__readmore">
									подробнее
								</a>
						...
						<div class="col-xl-3 col-md-6">
							<div class="program-card">
								...
								<a href="training-vo.php" class="program-card__readmore">
									подробнее
								</a>
								<ul class="program-card__list">
									<li>
						...
						<div class="col-xl-3 col-md-6">
							<div class="program-card">
								...
								<a href="#" class="program-card__readmore">
									подробнее
								</a>
								<ul class="program-card__list">
									<li>
			...
			<div class="graduates-content">
				<div class="container">
					...
					<div class="graduates-gallery">
						<?php echo do_shortcode('[envira-gallery slug="nashi-vypuskniki"]') ?>
					</div>
				</div>
			</div>
		</div>
