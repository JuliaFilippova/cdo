...
<?php get_template_part('header') ?>
	<section class="distance-learning" id="distance-learning">
		<div class="section-container">
			<div class="training-content training-content_ksu">
				...
				<!-- вывод карточек 6шт обучение -->
				<div class="training-list training-list_ksu d-flex">
					<?php 
						$args = array(
							'post_type' => 'program',
							'posts_per_page' => 6,
					...
					<!-- <div class="training-list__item">
						...
						<p>
							Экономика <br> и бухгалтерский учет <br> (38.02.01)
						</p>
					</div>
					<div class="training-list__item">
						<img src="<?php bloginfo('template_directory')?>/img/ksu/training-list3.png" alt="Изображение">
						<p>
							Право и организация <br> социального <br> обеспечения <br>(40.02.01)
						</p>
					</div>
					<div class="training-list__item">
						<img src="<?php bloginfo('template_directory')?>/img/ksu/training-list4.png" alt="Изображение">
						<p>
							Туризм <br> (43.02.10)
						</p>
					</div>
					<div class="training-list__item">
						<img src="<?php bloginfo('template_directory')?>/img/ksu/training-list5.png" alt="Изображение">
						<p>
							Организация <br> обслуживания <br>  в общественном <br> питании
						</p>
					</div>
					<div class="training-list__item">
						<img src="<?php bloginfo('template_directory')?>/img/ksu/training-list6.png" alt="Изображение">
						<p>
							Гостиничный сервис <br> (43.02.11)
						</p>
					</div> -->
				</div>
				<div class="training-content__box">
				...
				<div class="training-info__gallery-license training-info__gallery-license_ksu">
